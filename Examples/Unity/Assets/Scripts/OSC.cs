...
public class UDPPacketIO
{
    ...
    public bool Open()
    {
        ...
        {
            UnityEngine.Debug.LogWarning("cannot open udp client interface at port " + localPort);
    ...
    public void Close()
    {
        ...
        {
            Receiver.Close();
            //UnityEngine.Debug.Log("UDP receiver closed");
        }
        Receiver = null;
        socketsOpen = false;
    ...
    public void SendPacket(byte[] packet, int length)
    {
        ...
        UnityEngine.Debug.Log("osc message sent to "+remoteHostName+" port "+remotePort+" len="+length);
...
public class OSC : MonoBehaviour
{
    ...
    [Space(5)]
    [Tooltip("Añadir puerto")]
    public int inPort = 10000;
    [Space(5)]
    [Tooltip("Añadir ip de la maquina")]
    public string outIP = "192.168.10.125";
    [Space(5)]
    [Tooltip("Añadir puerto")]
  ...
  //  bool _isInit = false;   // !!!!!
    ...
    void Update()
    {
      ...
      //  if (!_isInit) return;    // !!!!!
        ...
        if (messagesReceived.Count > 0)
        {
           ...
           // UnityEngine.Debug.Log("received " + messagesReceived.Count + " messages");
            lock (ReadThreadLock)
            {
    ...
    */
    ...
    private void Read()
    {
        ...
        {
           UnityEngine.Debug.Log("ThreadAbortException" + e);
        }
        finally
        {
    ...
    {
       // print("Send OscMessage oscMessage ");
    ...
    {
        print("OscMessage StringToOscMessage String Message");
